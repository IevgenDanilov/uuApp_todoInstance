//@@viewOn:imports
import { createVisualComponent, useDataList, Lsi, LevelProvider, DynamicLibraryComponent } from "uu5g05";
...
let ControlPanel = createVisualComponent({
  ...
  render(props) {
    //@@viewOn:private
    const { state, data, errorData } = useDataList({ handlerMap: { load: Calls.getWorkspace } });
    //@@viewOff:private
